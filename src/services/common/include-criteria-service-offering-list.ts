 ...
 */
export const includeCriteriaServiceOfferingList: any = z.lazy(() => {
  return z.object({
 ...
 */
export const includeCriteriaServiceOfferingListResponse: any = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const includeCriteriaServiceOfferingListRequest: any = z.lazy(() => {
  return z
