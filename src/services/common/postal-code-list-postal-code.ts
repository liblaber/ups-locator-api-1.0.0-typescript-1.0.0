 ...
 */
export const postalCodeListPostalCode: any = z.lazy(() => {
  return z.object({
 ...
 */
export const postalCodeListPostalCodeResponse: any = z.lazy(() => {
  return z
    .object({
      PrimaryPostalCode: z.string().min(1).max(10),
      SecondaryPostalCode: z.string().min(1).max(10).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const postalCodeListPostalCodeRequest: any = z.lazy(() => {
  return z
