 ...
 */
export const dropLocationAddressKeyFormat: any = z.lazy(() => {
  return z.object({
 ...
 */
export const dropLocationAddressKeyFormatResponse: any = z.lazy(() => {
  return z
    .object({
      ConsigneeName: z.string().optional(),
      AddressLine: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const dropLocationAddressKeyFormatRequest: any = z.lazy(() => {
  return z
    .object({
